...
class recurrent_DyGrEncoder(torch.nn.Module):
    def __init__(self, node_features,dim_h1=256,out_features=128):
        super(recurrent_DyGrEncoder, self).__init__()

        self.fc0 = nn.Linear(node_features, dim_h1)

        self.recurrent = DyGrEncoder(conv_out_channels=dim_h1, conv_num_layers=1, conv_aggr="mean", lstm_out_channels=out_features, lstm_num_layers=1)
    ...
    def forward(self, x, edge_index, edge_weight=None):
        ...
        h, h_0, c_0 = self.recurrent(x, edge_index, edge_weight, self.h_0, self.c_0)
